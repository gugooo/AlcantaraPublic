...
using System.IO;
using Alcantara.ViewModels.Admin;
        ...
        public async Task<JsonResult> AddProuct(string ProductData, [FromForm]IFormFileCollection NewIMGs) {
            try
            {
                ...
                else if (!string.IsNullOrEmpty(NewProduct.ProductId) && !string.IsNullOrEmpty(NewProduct.ProductTypeId))//change Product and Product Type
                {
                    ...
                    if (NewProduct.Description != CultureData.GetDefoultName(_prType.CultureDescription, Culture)) _prType.CultureDescription = CultureData.SetOrChangeCultureName(_prType.CultureDescription, NewProduct.Title, Culture);
